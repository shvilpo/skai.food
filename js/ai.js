...
- plantPercent — доля растительного сырья по массе (овощи, крупы, фрукты, бобовые, орехи = 100; мясо/молочное/яйца/рыба = 0; смешанные — оцени по составу). Рафинированные сахар и масло считай за 0.
...
export async function lookupFood(query) {
  const prompt = `Дай пищевую ценность продукта «${query.trim()}»: ккал, белок, клетчатка (пищевые волокна).
...
- plantPercent — доля растительного сырья по массе: мясо, рыба, яйца, молочное = 0; овощи, крупы, фрукты, бобовые, орехи = 100; смешанные — оцени по составу. Рафинированные сахар и масло = 0.
